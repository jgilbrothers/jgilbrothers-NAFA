...
export const isVerifiedTransaction = (transaction: Transaction): boolean => transaction.verification_status === 'confirmed' || transaction.verification_status === 'corrected';
